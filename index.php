    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><button class="btn btn-muted navbar-btn" id="signUpButton" data-toggle="modal" data-target="#exampleModal"><span class="glyphicon glyphicon-user"></span> Login</button></li>
